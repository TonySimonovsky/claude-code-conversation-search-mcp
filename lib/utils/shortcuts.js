...
export class ShortcutManager {
     ...
     */
    async getOrCreateShortcut(projectPath, projectName) {
     ...
     */
    generateShortcutName(projectName) {
     ...
     */
    async createShortcut(name, targetPath) {
     ...
     */
    async createWindowsShortcut(name, targetPath) {
     ...
     */
    async createUnixSymlink(name, targetPath) {
        const linkPath = path.join(this.shortcutsDir, name);
     ...
     */
    getShortcutCommand(shortcutName) {
        const platform = os.platform();
        switch (platform) {
            case 'win32':
